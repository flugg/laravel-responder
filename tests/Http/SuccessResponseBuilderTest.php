...
/**
 * Collection of unit tests for the [\Flugg\Responder\Http\SuccessResponseBuilder] class.
 *
...
class SuccessResponseBuilderTest extends TestCase
{
    ...
    /**
     * Test that the [getTransformation] method returns an instance of [\League\Fractal
     * \Resource\ResourceAbstract] from the response builder.
     *
     * @test
     */
    public function getTransformationMethodShouldReturnTheTransformation()
    {
        // Arrange...
        $responseBuilder = $this->app->make('responder.success');

        // Act...
        $transformation = $responseBuilder->transform([])->getTransformation();
    ...
    /**
     * Test that the [getTransformation] method returns null if you haven't called on the
     * [transform] method beforehand.
     *
     * @test
     */
    public function getTransformationMethodShouldReturnNullBeforeTransforming()
    {
        // Arrange...
        $responseBuilder = $this->app->make('responder.success');

        // Act...
        $transformation = $responseBuilder->getTransformation();
